...
const Info = () =>{
    ...
    <div className="col d-flex justify-content-center ">
        ...
        <p className="text-white text-center mb-0"><b>Kurokami</b> adalah Aplikasi Baca Manhwa dan Komik <b>Gratis</b> yang mudah digunakan. Tanpa perlu login, cukup buka dan langsung mulai membaca. Terdapat sedikit <b>Iklan</b> dalam aplikasi, namun tidak menggangu dalam membaca</p>
  ...
  <div class="collapse" id="collapseExample">
        <div className="col bg-dark m-2 rounded p-2">
            ...
            The content available in the <b>Kurokami</b> app is sourced directly from the website  <b>manhwaindo.net</b> . We do not host, store, or own any of the content provided within our application. All content remains the property of its respective owners, and our app simply aggregates this content for easy access. If you have any concerns regarding the content, please refer to the original source at  <b>manhwaindo.net</b> .
            </p>
        </div>
</div>
  ...
  <div class="collapse" id="privacy">
        ...
        <p className="text-white">Kurokami adalah aplikasi baca manhwa dan komik yang sepenuhnya gratis dan tidak memerlukan fitur login. Oleh karena itu, kami tidak mengumpulkan, menyimpan, atau menggunakan data pribadi pengguna. Kami tidak meminta informasi apa pun dari Anda, termasuk nama, alamat email, atau data pribadi lainnya.</p>

        <h6 class="card-subtitle mb-2 text-white fw-bold">2. Penggunaan Data</h6>
        <p className="text-white">Karena kami tidak mengumpulkan data pribadi, kami tidak menggunakan data Anda untuk tujuan apa pun. Aplikasi ini hanya memungkinkan Anda untuk membaca manhwa dan komik tanpa perlu login atau mendaftar.</p>
        ...
        <p className="text-white">Jika Anda memiliki pertanyaan atau kekhawatiran mengenai kebijakan privasi ini, silakan hubungi kami di <a href="mailto:agungcakra888@gmail.com" className="text-white fw-bold">Email ini</a></p>
        </div>
</div>
